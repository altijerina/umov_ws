...
#define NODE_MAIN_LOGGER_NAME "arduino_task_server_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libarduino_task_server.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<arduino_remote::ArduinoTaskServer>";
