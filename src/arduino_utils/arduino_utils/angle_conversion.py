...
# To use this code, type the following:
# ros2 service call /euler_to_quaternion arduinobot_msgs/srv/EulerToQuaternion double-quote roll  -then tab twice
# and fill in roll:   pitch:   yaw:

# or 
# ros2 service call/quaternion_to_euler arduinobot_msgs/srv/QuaternionToEuler double-quote x  -then tab twice and 
# fill in x:  y:  z:  w:
