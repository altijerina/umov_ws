...
public:
    ...
    {
        service_ = create_service<arduino_msgs::srv::AddTwoInts>("add_two_ints", std::bind(&SimpleServiceServer::serviceCallback, this, _1, _2));
        RCLCPP_INFO(rclcpp::get_logger("rclcpp"), "Service add_two_ints Ready");
    }


private:
    rclcpp::Service<arduino_msgs::srv::AddTwoInts>::SharedPtr service_;

    void serviceCallback(const std::shared_ptr<arduino_msgs::srv::AddTwoInts::Request> req,
                         const std::shared_ptr<arduino_msgs::srv::AddTwoInts::Response> res)
    {
