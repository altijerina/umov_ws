...
action_client = ActionClient(Node("arduino_alexa_interface"), ArduinoTask, "arduino_task_server" )
app = Flask(__name__)
...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        arduino_goal = ArduinoTask.Goal()
        arduino_goal.arduino_task_number = 0
        action_client.send_goal_async(arduino_goal)            
...
class PositionOneHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        arduino_goal = ArduinoTask.Goal()
        arduino_goal.arduino_task_number = 1
        action_client.send_goal_async(arduino_goal)            
        return handler_input.response_builder.response    
...
class PositionTwoHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        arduino_goal = ArduinoTask.Goal()
        arduino_goal.arduino_task_number = 2
        action_client.send_goal_async(arduino_goal)            
        return handler_input.response_builder.response     
...
class PositionThreeHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        arduino_goal = ArduinoTask.Goal()
        arduino_goal.arduino_task_number = 3
        action_client.send_goal_async(arduino_goal)            
        return handler_input.response_builder.response   
...
class PositionFourHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        arduino_goal = ArduinoTask.Goal()
        arduino_goal.arduino_task_number = 4
        action_client.send_goal_async(arduino_goal)            
        return handler_input.response_builder.response 
...
class PositionFiveHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        arduino_goal = ArduinoTask.Goal()
        arduino_goal.arduino_task_number = 5
        action_client.send_goal_async(arduino_goal)            
        return handler_input.response_builder.response 
...
class PositionSixHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        # type: (HandlerInput) -> Response
        speech_text = "Ok, I'm going to Position Six."
        ...
        arduino_goal = ArduinoTask.Goal()
        arduino_goal.arduino_task_number = 6
        action_client.send_goal_async(arduino_goal)            
        return handler_input.response_builder.response     
...
skill_adapter = SkillAdapter(
    skill=skill_builder.create(), skill_id="amzn1.ask.skill.b6bfcb24-ddee-41e5-93ff-52997b706f05", app=app)
